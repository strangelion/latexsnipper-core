...
impl Platform {
    ...
    pub fn onnx_url(&self, version: &str, accel: Acceleration) -> String {
        let base = format!("https://github.com/microsoft/onnxruntime/releases/download/v{}", version);
        match (self, accel) {
            ...
            (Platform::WindowsX64, Acceleration::Tensorrt) =>
                format!("{}/onnxruntime-win-x64-gpu_cuda12-{}.zip", base, version), // TensorRT uses CUDA backend
            ...
            (Platform::LinuxX64, Acceleration::Tensorrt) =>
                format!("{}/onnxruntime-linux-x64-gpu_cuda12-{}.tgz", base, version), // TensorRT uses CUDA backend
            (Platform::LinuxAarch64, _) =>
                format!("{}/onnxruntime-linux-aarch64-{}.tgz", base, version),
            (Platform::MacOsArm64, _) =>
                format!("{}/onnxruntime-osx-arm64-{}.tgz", base, version),
            (Platform::Unknown, _) =>
                format!("{}/onnxruntime-win-x64-{}.zip", base, version),
        }
    }
