...
addition advanced the executable capability schema from `2.0.0` to `2.1.0`;
the public v3 runtime integration subsequently promotes it to `3.0.0` without
changing the meaning of those independent dimensions;
